...
import forImg from "./forImg.png";
// import Tobi from "./tobi.png";
// import code from "./code.png";
// import adeBola from "./adebola.png";
// import political from "./political.png";
...
function Feeds() {
  ...
  useEffect(() => {
    fetch("http://nubeero-deployment-server.uksouth.cloudapp.azure.com:9909/api/user/allPost")
      .then((response) => response.json())
      .then((data) => {
        // console.log(data);
        if (data !== null) {
          setPostArray(data);
          // setRows(data.outputPayload);
          // console.log(data.outputPayload.length);
          // setNumberTypeRowSize(data.outputPayload.length);
        }
      })
      .catch((err) => {
        console.log(err.message);
    ...
    <>
      <div className=" w-[100%] ">
        ...
        <div className="ml-[20.9%]">
          ...
          <div className=" ml-[3%] mt-[25px] border-[1px] w-[90%] h-[350vh] border-[#D0D0D0]">
            <div className=" flex w-[85%] ml-[60px] mt-[10px] justify-between items-center">
              <div>
                <h1 className=" text-[32px] text-[#111111] font-[500] ">FEED</h1>
            ...
            <div className=" ml-[60px]  mt-[25px] rounded-[8px]  border-[1px] w-[85%] h-[80px] border-[#D0D0D0]">
              <div className="flex items-center justify-between ml-[30px] w-[90%] mt-[20px] ">
                <div onClick={handleForYou} className={forYou ? "text-[24px] text-[#543EE0] border-b-[4px] h-[60px] border-b-[#543EE0] cursor-pointer font-[400]  " : "text-[24px] cursor-pointer text-[#111111]  h-[60px] font-[400] "}>
                  For you
                </div>
                <div onClick={handleFeatured} className={featured ? "text-[24px] text-[#543EE0] border-b-[4px] h-[60px] border-b-[#543EE0] cursor-pointer font-[400]  " : "text-[24px] cursor-pointer text-[#111111]  h-[60px] font-[400] "}>
                  {" "}
                  Featured
                </div>
                <div onClick={handleRecent} className={recent ? "text-[24px] text-[#543EE0] border-b-[4px] h-[60px] border-b-[#543EE0] cursor-pointer font-[400]  " : "text-[24px] cursor-pointer text-[#111111]  h-[60px] font-[400] "}>
                  Recent
                </div>
              </div>
            </div>
            <div className=" ml-[60px]   rounded-[8px]  border-[1px] w-[85%] h-[310vh] border-[#D0D0D0]">
              {forYou && (
                <div className="">
                  <div className="h-[100vh] border-b-[1px] border-b-[#D0D0D0] ">
                    {postArray.map((item: any, index) => (
                      <div key={index}>
                        <h1>{item.fullName}</h1>
                        <h2>{item.occupation}</h2>
                        <div className="flex mt-[40px] ml-[40px] justify-between items-center w-[380px] ">
                          <img className=" rounded-[50%] " src={fYou} alt="Grace" />
                          <div>
                            <h1 className=" text-[24px] text-[#111111] font-[500] ">{item.fullName}</h1>
                            <p className=" text-[#626262] font-[400] text-[18px] v">{`${item.occupation}  ${item.date}`}</p>
                          </div>
                        </div>
                        <div className="ml-[40px] mt-[8px] ">
                          <h1 className=" text-[32px] font-[500] text-[#111111] "> {item.title}</h1>
                          ...
                          <div className="w-[75%] mt-[27px]">
                            <p className="text-[18px] text-[#626262] ">{item.message}</p>
                            <img className=" mt-[12px] " src={forImg} alt="people" />
                  ...
                  {/* <div className="h-[97vh] border-b-[1px] border-b-[#D0D0D0] ">
                    <div className="flex mt-[40px] ml-[40px] justify-between items-center w-[400px] ">
                      <img className=" rounded-[50%] " src={Tobi} alt="tobi" />
                      <div>
                        <h1 className=" text-[24px] text-[#111111] font-[500] ">Oluwatobi Ogunniyi</h1>
                        <p className=" text-[#626262] font-[400] text-[18px] v">Software developer .May 22th, 2023</p>
                      </div>
                    </div>
                    <div className="ml-[40px] mt-[8px] ">
                      <h1 className=" text-[32px] font-[500] text-[#111111] ">Using CSS Selectors</h1>
                      <div className="flex mt-[8px] items-center justify-between w-[120px]">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M21.75 3.77344H16.3875C15.2367 3.77344 14.1117 4.10391 13.1437 4.72734L12 5.46094L10.8563 4.72734C9.88924 4.10403 8.76299 3.77282 7.6125 3.77344H2.25C1.83516 3.77344 1.5 4.10859 1.5 4.52344V17.8359C1.5 18.2508 1.83516 18.5859 2.25 18.5859H7.6125C8.76328 18.5859 9.88828 18.9164 10.8563 19.5398L11.8969 20.2102C11.9273 20.2289 11.9625 20.2406 11.9977 20.2406C12.0328 20.2406 12.068 20.2313 12.0984 20.2102L13.1391 19.5398C14.1094 18.9164 15.2367 18.5859 16.3875 18.5859H21.75C22.1648 18.5859 22.5 18.2508 22.5 17.8359V4.52344C22.5 4.10859 22.1648 3.77344 21.75 3.77344ZM7.6125 16.8984H3.1875V5.46094H7.6125C8.44219 5.46094 9.24844 5.69766 9.94453 6.14531L11.0883 6.87891L11.25 6.98438V17.8125C10.1344 17.2125 8.8875 16.8984 7.6125 16.8984ZM20.8125 16.8984H16.3875C15.1125 16.8984 13.8656 17.2125 12.75 17.8125V6.98438L12.9117 6.87891L14.0555 6.14531C14.7516 5.69766 15.5578 5.46094 16.3875 5.46094H20.8125V16.8984ZM9.30234 8.46094H4.94766C4.85625 8.46094 4.78125 8.54063 4.78125 8.63672V9.69141C4.78125 9.7875 4.85625 9.86719 4.94766 9.86719H9.3C9.39141 9.86719 9.46641 9.7875 9.46641 9.69141V8.63672C9.46875 8.54063 9.39375 8.46094 9.30234 8.46094ZM14.5312 8.63672V9.69141C14.5312 9.7875 14.6062 9.86719 14.6977 9.86719H19.05C19.1414 9.86719 19.2164 9.7875 19.2164 9.69141V8.63672C19.2164 8.54063 19.1414 8.46094 19.05 8.46094H14.6977C14.6062 8.46094 14.5312 8.54063 14.5312 8.63672ZM9.30234 11.7422H4.94766C4.85625 11.7422 4.78125 11.8219 4.78125 11.918V12.9727C4.78125 13.0688 4.85625 13.1484 4.94766 13.1484H9.3C9.39141 13.1484 9.46641 13.0688 9.46641 12.9727V11.918C9.46875 11.8219 9.39375 11.7422 9.30234 11.7422ZM19.0523 11.7422H14.6977C14.6062 11.7422 14.5312 11.8219 14.5312 11.918V12.9727C14.5312 13.0688 14.6062 13.1484 14.6977 13.1484H19.05C19.1414 13.1484 19.2164 13.0688 19.2164 12.9727V11.918C19.2188 11.8219 19.1438 11.7422 19.0523 11.7422Z"
                      ...
                      <div className="w-[75%] mt-[27px]">
                        ...
                        <img className=" mt-[12px] " src={code} alt="</>" />
                        <div className=" flex justify-between mt-[14px] items-center ">
                          <div className="flex mt-[8px] items-center justify-between w-[60px]">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                  ...
                  <div className="h-[98vh]  ">
                    <div className="flex mt-[40px] ml-[40px] justify-between items-center w-[420px] ">
                      <img className=" rounded-[50%] " src={adeBola} alt="Adebola" />
                      <div>
                        <h1 className=" text-[24px] text-[#111111] font-[500] ">Adebobola Muhydeen</h1>
                        <p className=" text-[#626262] font-[400] text-[18px] v">Adebobola Muhydeen .May 23th, 2023</p>
                      </div>
                    </div>
                    <div className="ml-[40px] mt-[8px] ">
                      <h1 className=" text-[32px] font-[500] text-[#111111] ">The Impact of social media on Political discourse</h1>
                      <div className="flex mt-[8px] items-center justify-between w-[120px]">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            d="M21.75 3.77344H16.3875C15.2367 3.77344 14.1117 4.10391 13.1437 4.72734L12 5.46094L10.8563 4.72734C9.88924 4.10403 8.76299 3.77282 7.6125 3.77344H2.25C1.83516 3.77344 1.5 4.10859 1.5 4.52344V17.8359C1.5 18.2508 1.83516 18.5859 2.25 18.5859H7.6125C8.76328 18.5859 9.88828 18.9164 10.8563 19.5398L11.8969 20.2102C11.9273 20.2289 11.9625 20.2406 11.9977 20.2406C12.0328 20.2406 12.068 20.2313 12.0984 20.2102L13.1391 19.5398C14.1094 18.9164 15.2367 18.5859 16.3875 18.5859H21.75C22.1648 18.5859 22.5 18.2508 22.5 17.8359V4.52344C22.5 4.10859 22.1648 3.77344 21.75 3.77344ZM7.6125 16.8984H3.1875V5.46094H7.6125C8.44219 5.46094 9.24844 5.69766 9.94453 6.14531L11.0883 6.87891L11.25 6.98438V17.8125C10.1344 17.2125 8.8875 16.8984 7.6125 16.8984ZM20.8125 16.8984H16.3875C15.1125 16.8984 13.8656 17.2125 12.75 17.8125V6.98438L12.9117 6.87891L14.0555 6.14531C14.7516 5.69766 15.5578 5.46094 16.3875 5.46094H20.8125V16.8984ZM9.30234 8.46094H4.94766C4.85625 8.46094 4.78125 8.54063 4.78125 8.63672V9.69141C4.78125 9.7875 4.85625 9.86719 4.94766 9.86719H9.3C9.39141 9.86719 9.46641 9.7875 9.46641 9.69141V8.63672C9.46875 8.54063 9.39375 8.46094 9.30234 8.46094ZM14.5312 8.63672V9.69141C14.5312 9.7875 14.6062 9.86719 14.6977 9.86719H19.05C19.1414 9.86719 19.2164 9.7875 19.2164 9.69141V8.63672C19.2164 8.54063 19.1414 8.46094 19.05 8.46094H14.6977C14.6062 8.46094 14.5312 8.54063 14.5312 8.63672ZM9.30234 11.7422H4.94766C4.85625 11.7422 4.78125 11.8219 4.78125 11.918V12.9727C4.78125 13.0688 4.85625 13.1484 4.94766 13.1484H9.3C9.39141 13.1484 9.46641 13.0688 9.46641 12.9727V11.918C9.46875 11.8219 9.39375 11.7422 9.30234 11.7422ZM19.0523 11.7422H14.6977C14.6062 11.7422 14.5312 11.8219 14.5312 11.918V12.9727C14.5312 13.0688 14.6062 13.1484 14.6977 13.1484H19.05C19.1414 13.1484 19.2164 13.0688 19.2164 12.9727V11.918C19.2188 11.8219 19.1438 11.7422 19.0523 11.7422Z"
                      ...
                      <div className="w-[75%] mt-[27px]">
                        ...
                        <img className=" mt-[12px] " src={political} alt="people" />
                        <div className=" flex justify-between mt-[14px] items-center ">
                          <div className="flex mt-[8px] items-center justify-between w-[60px]">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
